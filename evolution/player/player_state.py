...
from view_model.view_player_state import ViewPlayerState
...
class PlayerState:
    ...
    def __repr__(self):
        return "PlayerState({}, {}, {}, {})".format(repr(self.id),
                                                    repr(self.species_list),
                                                    repr(self.food_bag),
                                                    repr(self.hand))
    ...
    def __eq__(self, other):
        return isinstance(other, PlayerState) and \
               ...
               self.species_list == other.species_list and \
               self.food_bag == other.food_bag and \
